...
def main(input,output_image):
    ...
    def detect(imgpath, nn):
        ...
        print("THE output image is",output_image)
        cv2.imwrite(output_image, image)
       
        print("THE impath is",impath)
    detect(impath, net)

if __name__=="__main__":
    input="/home/prashant/Documents/flask-app/static/uploaded/test.jpg"
    output_image="/home/prashant/Documents/flask-app/static/displayed/test_final.jpg"
    main(input,output_image)
